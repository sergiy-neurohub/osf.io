...
#       when 18.220.11.125 inside a container != 18.220.11.125 on the client machine/docker host.
...
EMBER_DOMAIN = environ.get('EMBER_DOMAIN', '18.220.11.125')
...
# Email
USE_EMAIL = False
MAIL_SERVER = '18.220.11.125:1025'  # For local testing
